...
Uses your **Kimi membership** (OAuth from `kimi login`), not pay-as-you-go Open Platform API:

Run in the repository root: `cd tools/librarian` then `python -m librarian.cli breedables-research`.

Output: `research/discoveries/breedables-inventory-kimi.md`. Merge verified additions into this page.
