...
- [Phase 0 survey](./2026-08-23-open-source-toolbox-survey.md) — good R&D; wrong shape for Academy  
- [Studio roadmap](../../docs/studio-roadmap.md) — phases assume registry-first; needs revision  
- [Academy overview (current)](../../docs/academy/overview.md) — empty shell  
- [Wiki audit (wiki copy)](../../docs/research/wiki-concept-audit.md)  
- [Librarian README](../../tools/librarian/README.md) — working ops layer  
