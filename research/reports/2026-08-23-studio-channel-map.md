...
**Related:** [Wiki concept audit](2026-08-23-wiki-concept-audit.md)
...
2. **Registry/compliance** (`EXPERIMENTAL`, licenses) lives in `#tools-registry` — not in Academy-facing channels.  
...
- [Wiki concept audit](2026-08-23-wiki-concept-audit.md)  
- [Studio roadmap](../../docs/studio-roadmap.md)  
- [Librarian README](../../tools/librarian/README.md)  
- [Slack manifest](../../tools/librarian/slack-manifest.yaml)
