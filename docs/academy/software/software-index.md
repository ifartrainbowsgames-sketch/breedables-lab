...
|------|------|---------------|-------------|
| **Blender** (shader editor, texture paint, bake) ⭐ | Free | The default texturing environment | Core path — see [B07](blender/b07-texture-painting-pbr.md); [registry](../../production/tools/blender.md) |
...
| [Ucupaint](https://github.com/ucupumar/ucupaint) ⭐ | Free (open-source) | Layer-based painting **inside Blender** | Variant layers & wear for [A02](../tracks/a02-layered-textures.md); [registry](../../production/tools/ucupaint.md) |
...
| Tool | Cost | What it's for | Studio note |
|------|------|---------------|-------------|
| **Blender manual retopo** ⭐ | Free | Full-control retopology for deforming meshes | Primary path for creatures; [B05](blender/b05-retopology.md) |
...
Rule: AI output is a **concept blockout**. It enters the pipeline at modeling/sculpt ([B04](blender/b04-sculpting.md)), then goes through retopo/UV/texture/rig like any other mesh.
...
| Tool | Cost | What it's for | Studio note |
|------|------|---------------|-------------|
| Second Life viewer (official or Firestorm) | Free | Upload mesh/materials, in-world testing | Required for the in-world proofs in [B07](blender/b07-texture-painting-pbr.md)/[B10](blender/b10-export-to-sl.md) |
| [lsl-definitions](https://github.com/secondlife/lsl-definitions) | Free (open) | Canonical LSL/SLua definitions | Scripting accuracy for [A05](../tracks/a05-sl-fixture.md); [platform baseline](../../secondlife/platform-baseline.md) |
