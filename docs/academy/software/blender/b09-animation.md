...
**Learning path:** [Blender Foundations](index.md) · Lesson 9 of 10
**Production stage:** 8 Animation · **Prerequisites:** [B08](b08-rigging-weight-painting.md)
...
| SL — Uploading & animating a model | [Uploading and animating an avatar model](https://wiki.secondlife.com/wiki/uploading_and_animating_an_avatar_model) |
...
3. SL animation upload accepts **BVH** or (via Avastar) **.anim**; you'll finalize the export format in [B10](b10-export-to-sl.md). Note SL priority, loop in/out points, and hand/ease settings there.
...
[B10 — Exporting to Second Life](b10-export-to-sl.md)
