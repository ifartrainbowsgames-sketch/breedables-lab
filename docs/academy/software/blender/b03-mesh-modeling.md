...
!!! abstract "Lesson 3 of 10 · [Blender foundations](index.md)"
    ...
    **Prerequisites** — [Lesson 2](b02-interface-navigation.md)  
...
→ Full Blender playlist: [Video library — Blender](../../resources/video-library.md#blender)
...
4. Add **loop cuts** at joints (shoulder, elbow, hip, knee) — you need extra loops exactly where the mesh will bend for rigging in [Lesson 8](b08-rigging-weight-painting.md).
...
- **Even quads.** Avoid long thin faces on areas that will be textured — they stretch UVs in [Lesson 6](b06-uv-unwrapping.md).
...
[Lesson 4 — Sculpting basics](b04-sculpting.md)
