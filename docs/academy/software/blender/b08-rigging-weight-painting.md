...
!!! abstract "Lesson 8 of 10 · [Blender foundations](index.md)"
    ...
    **Prerequisites** — [Lesson 7](b07-texture-painting-pbr.md)  
...
- Animesh has a **triangle limit** and counts toward land impact; keep the mesh lean (see [Lesson 5](b05-retopology.md)).
- For learning the *mechanics* of rigging and weighting, **Rigify** (free, bundled) is the studio baseline; for the *actual SL export path* you retarget/transfer to the SL skeleton (Avastar or manual) in [Lesson 10](b10-export-to-sl.md).
...
[Lesson 9 — Basic animation](b09-animation.md)
