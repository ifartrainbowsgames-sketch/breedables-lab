# B08 — Rigging & Weight Painting (for SL Animesh)

**Learning path:** [Blender Foundations](index.md) · Lesson 8 of 10
**Production stage:** 7 Rigging · **Prerequisites:** [B07](b07-texture-painting-pbr.md)
**Feeds track:** [A04 — Rig + Animation](../../tracks/a04-rig-animation.md)
...
> Add a verified Rigify-quadruped and a weight-painting video to the [videos index](../../resources/videos.md#a04-rig-animation) — A04 slots are open.
...
- Animesh has a **triangle limit** and counts toward land impact; keep the mesh lean (see [B05](b05-retopology.md)).
- For learning the *mechanics* of rigging and weighting, **Rigify** (free, bundled) is the studio baseline; for the *actual SL export path* you retarget/transfer to the SL skeleton (Avastar or manual) in [B10](b10-export-to-sl.md).
...
[B09 — Basic Animation](b09-animation.md)
