...
!!! abstract "Lesson 5 of 10 · [Blender foundations](index.md)"
    **Production stage** — 3 Retopo/LOD  
    **Prerequisites** — [Lesson 4](b04-sculpting.md)  
    **Feeds studio lab** — [Retopology](../../tracks/a03-retopology.md)  
...
→ [Video library — retopo & all software](../../resources/video-library.md#blender)
...
2. **Physics weight** — driven by the physics/collision shape (see [Lesson 10](b10-export-to-sl.md)).
...
3. Use the **Poly Build** tool (or extrude edges) to lay quads along the surface, following the same edge-flow rules from [Lesson 3](b03-mesh-modeling.md): loops around joints, along the spine and limbs.
...
- Export each as a separate object/file for the uploader ([Lesson 10](b10-export-to-sl.md)).
...
[Lesson 6 — UV unwrapping](b06-uv-unwrapping.md)
