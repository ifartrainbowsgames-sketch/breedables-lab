...
!!! abstract "Lesson 2 of 10 · [Blender foundations](index.md)"
    ...
    **Prerequisites** — [Lesson 1](b01-install-setup.md)  
...
1. Open your `sl-startup.blend` from [Lesson 1](b01-install-setup.md).
...
[Lesson 3 — Mesh modeling for organic creatures](b03-mesh-modeling.md)
