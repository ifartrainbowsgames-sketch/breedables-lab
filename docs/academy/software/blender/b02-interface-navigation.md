# B02 — Interface & Navigation

**Learning path:** [Blender Foundations](index.md) · Lesson 2 of 10
**Production stage:** 0 Tooling · **Prerequisites:** [B01](b01-install-setup.md)
...
1. Open your `sl-startup.blend` from [B01](b01-install-setup.md).
...
[B03 — Mesh Modeling for Creatures](b03-mesh-modeling.md)
