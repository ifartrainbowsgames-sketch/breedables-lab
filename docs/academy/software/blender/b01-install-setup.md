...
**Learning path:** [Blender Foundations](index.md) · Lesson 1 of 10
**Production stage:** 0 Tooling · **Prerequisites:** none
**Evidence folder:** `training/blender/b01/`
...
Getting scale and export add-ons right on day one prevents the two most common upload failures later ([B10](b10-export-to-sl.md)): wrong size in-world, and a missing Collada/glTF exporter when you try to export.
...
[B02 — Interface & Navigation](b02-interface-navigation.md)
