...
Getting scale and export add-ons right on day one prevents the two most common upload failures later ([Lesson 10](b10-export-to-sl.md)): wrong size in-world, and a missing Collada/glTF exporter when you try to export.
...
[Lesson 2 — Interface & navigation](b02-interface-navigation.md)
