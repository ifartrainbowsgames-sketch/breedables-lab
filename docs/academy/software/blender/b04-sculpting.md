# B04 — Sculpting Basics

**Learning path:** [Blender Foundations](index.md) · Lesson 4 of 10
**Production stage:** 2 Modeling · **Prerequisites:** [B03](b03-mesh-modeling.md)
...
- **Dynamic Topology (Dyntopo)** — adds/removes geometry under the brush as you sculpt. Best for free-form exploration where topology doesn't matter yet. Detail becomes a dense triangle soup that you *will* retopologise in [B05](b05-retopology.md).
...
Do **not** ship a sculpt to SL directly — millions of triangles = catastrophic land impact. The sculpt's job is to be the **source of shape and a normal-map bake target**. You will build a low-poly version in [B05](b05-retopology.md) and bake this detail onto it in [B07](b07-texture-painting-pbr.md).
...
[B05 — Retopology](b05-retopology.md)
