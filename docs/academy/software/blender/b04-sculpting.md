...
!!! abstract "Lesson 4 of 10 · [Blender foundations](index.md)"
    **Production stage** — 2 Modeling  
    **Prerequisites** — [Lesson 3](b03-mesh-modeling.md)  
...
- **Dynamic Topology (Dyntopo)** — adds/removes geometry under the brush as you sculpt. Best for free-form exploration where topology doesn't matter yet. Detail becomes a dense triangle soup that you *will* retopologise in [Lesson 5](b05-retopology.md).
...
Do **not** ship a sculpt to SL directly — millions of triangles = catastrophic land impact. The sculpt's job is to be the **source of shape and a normal-map bake target**. You will build a low-poly version in [Lesson 5](b05-retopology.md) and bake this detail onto it in [Lesson 7](b07-texture-painting-pbr.md).
...
[Lesson 5 — Retopology](b05-retopology.md)
