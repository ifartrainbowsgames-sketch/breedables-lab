# Build Plan — Blender & Tools Learning Wiki

**Date:** 2026-08-23 · **Status:** LIVING ROADMAP · **Owner:** Academy
**Related:** [Wiki-first strategy](../../studio/wiki-first-strategy.md) · [Content requirements](../../studio/channel-content-requirements.md) · [Wiki concept audit](../../research/wiki-concept-audit.md)
...
- In-world scripting/genetics/HUD — see [A05](../tracks/a05-sl-fixture.md) and the [production line](../production-line.md).
...
Reuse the studio template from [channel-content-requirements.md](../../studio/channel-content-requirements.md#academy-overview-tracks-a01a05). Every lesson page has:
...
## 6. Mapping to Academy tracks & wiki-first strategy
...
This directly advances the [wiki-first strategy](../../studio/wiki-first-strategy.md) Phase B checklist ("a new member can learn breedables without Slack docs") by supplying the learning content the [audit](../../research/wiki-concept-audit.md) found missing. Slack links to these pages; it does not duplicate them.
...
- [Content requirements](../../studio/channel-content-requirements.md) · [Wiki-first strategy](../../studio/wiki-first-strategy.md) · [Wiki concept audit](../../research/wiki-concept-audit.md)
