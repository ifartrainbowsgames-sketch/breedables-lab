---
title: "Complete workflow courses"
section: academy
type: reference
---
...
| Course | Software | Instructor | URL | Free? | Level | Produces |
|--------|----------|------------|-----|-------|-------|----------|
...
| Blender Fundamentals 4.5 LTS | Blender | Blender Studio | [Studio course](https://studio.blender.org/training/blender-fundamentals-45-lts/) | Free tier | Beginner | Text plus short clips |

---

## Still to find (checklist)

| Project type | Priority | Notes |
|--------------|----------|-------|
...
1. Verify URL with `daily-wiki` or lychee.  
2. Record instructor, software, duration, free/paid, artifact produced.  
3. Add row above + link from [software package](../research/software-database.md).
...
| CG Cookie | Structured full-pipeline courses | Free videos on [YouTube](https://www.youtube.com/@cg_cookie) · paid courses on cgcookie.com | [@cg_cookie](https://www.youtube.com/@cg_cookie) |
