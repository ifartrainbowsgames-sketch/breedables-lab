---
title: "Wiki & Academy concept audit"
section: meta
type: meta
---
...
- [Phase 0 survey](../research/index.md) — good R&D; wrong shape for Academy  
- [Studio roadmap](../roadmap.md) — phases assume registry-first; needs revision  
- [Academy overview (current)](../academy/index.md) — empty shell  
