...
!!! info "About this page"
    **Prerequisites** — [Lesson 6 — UV unwrapping](../tools/blender/uv-mapping.md) and [Lesson 7 — Texture painting & PBR materials](../tools/blender/pbr-materials.md)  
...
!!! danger "Prerequisites"
    **This lab does not teach Blender.** Complete [Lesson 6 — UV unwrapping](../tools/blender/uv-mapping.md) and [Lesson 7 — Texture painting & PBR materials](../tools/blender/pbr-materials.md) first. Material Maker is optional and is a separate app, not a Blender lesson.
...
- [Lesson 7 — Texture painting & PBR materials](../tools/blender/pbr-materials.md)
- [Lesson 6 — UV unwrapping](../tools/blender/uv-mapping.md)
- [Layered textures](layered-textures.md)
- [Second Life platform baseline](../second-life/platform-baseline.md)
- [Material Maker](../tools/material-maker/index.md)
- [Poly Haven](../tools/poly-haven/index.md)
- [ambientCG](../tools/ambientcg/index.md)
- [Adobe Substance 3D Painter](../tools/substance-painter/index.md)
