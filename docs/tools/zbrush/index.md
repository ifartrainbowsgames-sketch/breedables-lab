...
![ZBrush](../../assets/inline/zbrush.png){ width="120" }

| | |
|---|---|
| **Classification** | **PAID / COMMERCIAL** |
| **Official site** | [maxon.net/zbrush](https://www.maxon.net/en/zbrush) |
| **Download / trial** | [Try ZBrush](https://www.maxon.net/en/zbrush/try) |
| **Pricing** | [Buy ZBrush](https://www.maxon.net/en/zbrush/buy) |
| **Video library** | [Watch in wiki](#videos) — embedded tutorials |
| **BSR status** | **USE LATER** — industry sculpt reference |

## Pipeline stage

[High-poly sculpt](../../pipeline.md#2-high-poly-sculpt)

## Free alternative

[Blender sculpt — Lesson 4](../blender/sculpting.md)
...
Sculpt a creature **head** from PureRef board; export decimated mesh for retopo comparison.

**PASS:** Clear primary/secondary forms; no collapsed dynamesh holes; turntable screenshot.  
**Artifact:** `training/references/zbrush-comparison/` (optional pro track).
...
**[ZBrush Official YouTube Channel](https://www.youtube.com/@ZBrush)** — Source for official feature announcements, quick tips, and workflow demos.

**[FlippedNormals ZBrush Sculpting Tutorials](https://www.youtube.com/@FlippedNormals)** — Reliable beginner-friendly character and creature sculpting breakdowns.

**[CG Cookie ZBrush Training](https://cgcookie.com/search?query=zbrush)** — Structured exercises that build core sculpting habits for game and creature work.

**[ZBrushCentral Community and Gallery](https://www.zbrushcentral.com/)** — Community gallery and forum for inspiration, feedback, and sculpting challenges.
...
**[Gnomon Workshop ZBrush Courses](https://www.thegnomonworkshop.com/search?query=zbrush)** — Professional-grade courses covering anatomy, creature design, and production sculpting.
