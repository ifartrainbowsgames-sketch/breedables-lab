...
![Marmoset Toolbag](../../assets/inline/marmoset-toolbag.png){ width="120" }

| | |
|---|---|
| **Classification** | **PAID / COMMERCIAL** · 30-day trial |
| **Official site** | [marmoset.co/toolbag](https://marmoset.co/toolbag/) |
| **Download / trial** | [Try Toolbag](https://marmoset.co/toolbag/) |
| **Pricing** | [Pricing](https://marmoset.co/toolbag/pricing/) |
| **Video library** | [Watch in wiki](#videos) |
| **BSR status** | **USE LATER** — pro lookdev/bake reference |

## Pipeline stages

[Baking](../../pipeline.md#5-high-low-baking) · [Lookdev / preview](../../pipeline.md#7-lookdev-preview)

## Free alternative

Blender bake + EEVEE/Cycles · in-world SL PBR check
...
Bake normal + AO from sculpt/high to game mesh; turntable render for portfolio comparison.

**Artifact:** `training/references/marmoset-comparison/`
...
**[Marmoset Toolbag — baking props](https://marmoset.co/posts/baking-props-in-marmoset-toolbag/)** — High-to-low bake and lookdev reference
