...
2. **Physics weight** — driven by the physics/collision shape (see [Lesson 10](export-and-upload.md)).
...
- Export each as a separate object/file for the uploader ([Lesson 10](export-and-upload.md)).
...
- Tool: [RetopoFlow](https://github.com/CGCookie/retopoflow) — [catalog entry](addon-catalog.md#free-community) · [registry page](../retopoflow/index.md)
