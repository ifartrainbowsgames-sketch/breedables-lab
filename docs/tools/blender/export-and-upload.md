...
!!! abstract "Lesson 10 of 10 · [Blender foundations](index.md)"
    ...
    **Prerequisites** — [Lesson 9](animation.md)  
    **Feeds studio lab** — [In-world fixture](../../projects/in-world-fixture.md)  
...
3. **One material per intended SL face** (max 8). Keep the single-tile UVs from [Lesson 6](uv-mapping.md).
4. **Name objects** clearly per LOD (e.g. `creature_LOD0`…`LOD3`, `creature_PHYS`).

### Build LODs and physics

1. **LODs:** from [Lesson 5](retopology.md) you have High/Medium/Low/Lowest. You'll point the uploader at each. Supplying your own beats auto-decimation for both looks and land impact.
...
5. Read the **land impact** and **upload fee (L$)** the uploader shows. If LI is too high, go back to LODs/physics — don't just accept it. (See [Lesson 5](retopology.md) for the LI = max(download, physics, server) rule.)
6. Upload, rez, apply your PBR material/maps, and for animated creatures enable **Animesh** and script the animation triggers (that's [In-world fixture](../../projects/in-world-fixture.md)).

### Validate in-world (required)

Rez the creature, apply the material from [Lesson 7](pbr-materials.md), play the idle/walk from [Lesson 9](animation.md), and screenshot with viewer version, region, and date. Record final land impact.
...
You have taken a creature from zero to an SL-ready, rigged, textured, animated upload. Continue with the outcome labs: [Organic PBR material](../../projects/organic-pbr-material.md) → [In-world fixture](../../projects/in-world-fixture.md), and browse the [add-on catalog](addon-catalog.md) and [tutorial arsenal](../../academy/index.md) to go deeper.

## More tutorials

Lesson: [Lesson 10 — Exporting to Second Life](export-and-upload.md) · Track: [In-world fixture](../../projects/in-world-fixture.md)
