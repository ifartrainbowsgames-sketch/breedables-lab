...
!!! abstract "Lesson 7 of 10 · [Blender foundations](index.md)"
    ...
    **Prerequisites** — [Lesson 6](uv-mapping.md)  
...
2. **Paint colour** in Texture Paint mode directly on the model (or generate a procedural base in Material Maker and refine with [Ucupaint](../ucupaint/index.md) layers — this is the A02 workflow).
...
- For upload you can either apply the individual maps in SL's material editor or export the whole material as **glTF** ([Lesson 10](export-and-upload.md)).
...
[Lesson 8 — Rigging & weight painting](rigging-and-skinning.md)
