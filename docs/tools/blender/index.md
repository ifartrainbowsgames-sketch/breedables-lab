...
| Texturing | [PBR materials](pbr-materials.md) |
| Rigging & animation | [Rigging & skinning](rigging-and-skinning.md) · [Animation](animation.md) |
| Second Life delivery | [Export & upload](export-and-upload.md) |
