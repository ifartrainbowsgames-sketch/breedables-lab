...
3. SL animation upload accepts **BVH** or (via Avastar) **.anim**; you'll finalize the export format in [Lesson 10](export-and-upload.md). Note SL priority, loop in/out points, and hand/ease settings there.

### Why this matters for breedables

Idle + walk are the minimum believable life for an Animesh creature. Baked, well-named, looping clips are what the [In-world fixture](../../projects/in-world-fixture.md) triggers via script. Good easing is the difference between "alive" and "robotic".
...
[Lesson 10 — Exporting to Second Life](export-and-upload.md)
