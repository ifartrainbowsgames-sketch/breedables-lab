---
title: "Breedables studio roadmap"
type: reference
---
...
**Deliverables:**
- [Phase 0 toolbox survey](research/index.md) (wiki summary; [full report on GitHub](https://github.com/ifartrainbowsgames-sketch/breedables-lab/blob/feature/studio-librarian-v1/research/reports/2026-08-23-open-source-toolbox-survey.md))
...
| **Breedables webscreen** | Go CLI: chromedp screening + SearXNG search → `research/discoveries/` | MIT (scaffold) | `tools/webscreen/` · [wiki](research/web-research-stack.md) |
