...
→ Full spec: [Academy mission](../academy/mission.md)
...
| Before | After |
|--------|-------|
| Registry labels on “lesson” pages | [Professional workflow](../academy/professional-workflow/index.md) + [software packages](../academy/software/packages/index.md) |
| “Learn Blender” with no URLs | [Software page standard](../academy/software/software-page-standard.md) — verified training required |
| Invented lesson order | [Pipeline stages](../academy/professional-workflow/pipeline-stages.md) mirroring Gnomon/industry |
| OSS-only blind spot | [Paid vs free matrix](../academy/professional-workflow/paid-vs-free-matrix.md) — three routes |
...
|-------|----------|--------------|
| **Plain-English entry** | [start-here.md](../academy/start-here.md) | Explains the wiki without A01/B07 codes |
| **10 Blender lessons** | [software/blender/](../academy/software/blender/index.md) | Install → model → texture → rig → export to SL |
| **5 studio labs** | [tracks/](../academy/tracks/a01-organic-pbr.md) | Breedables proof projects with `training/` evidence |
| **Tutorial arsenal** | [tutorials.md](../academy/resources/tutorials.md) | Curated videos by pipeline stage |
| **Market research** | [breedables-market-study.md](../research/breedables-market-study.md) | SL breedables context for the studio |
| **Concept audit** | [wiki-concept-audit.md](../research/wiki-concept-audit.md) | Why registry ≠ Academy; design rules |
...
2. **Plain English first** — [start-here.md](../academy/start-here.md) is the model; codes are for folders only.
...
- [Studio roadmap](../studio-roadmap.md) — phases 0–6, OSS recommendations
- [Web research stack](../production/tools/web-research-stack.md) — chromedp, trafilatura, lychee, Kimi role
- [Wiki concept audit](../research/wiki-concept-audit.md) — what went wrong and how we fixed the concept
- [Wiki design benchmarks](wiki-design-benchmarks.md) — Outlands/Fandom patterns we copy
