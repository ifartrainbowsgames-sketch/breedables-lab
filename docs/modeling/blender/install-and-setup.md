...
Getting scale and export add-ons right on day one prevents the two most common upload failures later ([Lesson 10](../../second-life/export-and-upload.md)): wrong size in-world, and a missing Collada/glTF exporter when you try to export.
