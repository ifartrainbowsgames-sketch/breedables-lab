...
!!! info "About this page"
    **Prerequisites** — [Lesson 3 — Mesh modeling for organic creatures](../mesh-modeling.md) through [Lesson 5 — Retopology](../retopology.md)  
...
=== "Free tools"
    ...
    | Tool | Link | Best for |
    |---|---|---|
    | Blender | [Blender](../blender/index.md) | Native retopology tools, snapping, shrinkwrap, and final mesh export |
...
=== "Paid tools"
    ...
    | Tool | Link | Best for |
    |---|---|---|
    | RetopoFlow | [RetopoFlow](../software/retopoflow.md) | Dedicated quad-drawing retopology inside Blender |
    | TopoGun 3 | [TopoGun 3](../software/topogun.md) | Standalone retopology and map baking |
    | ZBrush | [ZBrush](../software/zbrush.md) | Sculpting source and ZRemesher baseline |
...
| [RetopoFlow tool page](../software/retopoflow.md) | Studio license and usage notes for production approval. |
...
Complete [Lesson 3 — Mesh modeling for organic creatures](../mesh-modeling.md) through [Lesson 5 — Retopology](../retopology.md) before starting this lab.
...
**License:** RetopoFlow is GPL; bundled assets may have different terms — read the [RetopoFlow tool page](../software/retopoflow.md) before production approval.
...
Continue to [Rig + animation](../../rigging-animation/projects/rig-and-animation.md) once the retopology sign-off checklist is complete.
...
- [RetopoFlow](../software/retopoflow.md)
