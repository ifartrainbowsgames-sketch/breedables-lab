...
!!! abstract "Lesson 3 of 10 · [Blender foundations](blender/index.md)"
    **Production stage** — 2 Modeling  
    **Prerequisites** — [Lesson 2](blender/interface-and-navigation.md)  
...
4. Add **loop cuts** at joints (shoulder, elbow, hip, knee) — you need extra loops exactly where the mesh will bend for rigging in [Lesson 8](../rigging-animation/rigging-and-skinning.md).
...
- Add-ons for hard-surface: [Hard Ops / Boxcutter](blender/addon-catalog.md#paid-but-worth-it), [MACHIN3tools](blender/addon-catalog.md#free-community).
