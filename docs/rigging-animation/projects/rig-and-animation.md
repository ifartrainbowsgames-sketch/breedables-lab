...
After this project is signed off, move on to [In-world fixture](../../engineering/projects/in-world-fixture.md) to connect the asset with breedables behaviour.
...
- [Rigging & weight painting](../rigging-and-skinning.md)
- [Basic animation](../animation.md)
- [Exporting to Second Life](../../second-life/export-and-upload.md)
- [Studio experiments](../../research/experiments.md)
- [Blender](../../modeling/blender/index.md)
- [In-world fixture](../../engineering/projects/in-world-fixture.md)
