...
!!! info "About this page"
    ...
    **Prerequisites** — [Rigging & skinning](rigging-and-skinning.md), then [Animation](animation.md)
...
!!! warning "Licence first, animation second"
    ...
    Audit before use; record the finding in the [tool registry](../research/tool-registry.md).
...
| [Animation retargeting](../research/candidates/animation-retargeting.md) | Under evaluation | Moves an existing action onto a different skeleton |
| [Rokoko Studio Live](../research/candidates/rokoko-studio-live.md) | Under evaluation | Live capture streamed into Blender |
...
[export & upload](../second-life/export-and-upload.md).

## Related

- [Rigging & skinning](rigging-and-skinning.md) — build the armature first
- [Animation](animation.md) — keyframing idle and walk cycles
- [Rig + animation project](projects/rig-and-animation.md) — the lab that proves it
- [Experiment E04](../research/experiments.md#e04-rig-and-retarget-baseline) — the retarget benchmark these sources feed
