---
title: "Lesson 9 — Basic animation"
section: rigging-animation
type: topic
---
# Lesson 9 — Basic animation

!!! abstract "Lesson 9 of 10 · [Blender foundations](../modeling/blender/index.md)"
    **Production stage** — 8 Animation  
    **Prerequisites** — [Lesson 8](rigging-and-skinning.md)  
...
> Add a verified quadruped walk-cycle video to the [videos index](../research/software-database.md).
...
3. SL animation upload accepts **BVH** or (via Avastar) **.anim**; you'll finalize the export format in [Lesson 10](../second-life/export-and-upload.md). Note SL priority, loop in/out points, and hand/ease settings there.

### Why this matters for breedables

Idle + walk are the minimum believable life for an Animesh creature. Baked, well-named, looping clips are what the [In-world fixture](../engineering/projects/in-world-fixture.md) triggers via script. Good easing is the difference between "alive" and "robotic".
...
Lesson: [Lesson 9 — Basic animation](animation.md) · Track: [Rig + animation](projects/rig-and-animation.md)
...
- SL: [Uploading a rigged mesh](https://wiki.secondlife.com/wiki/Mesh/Uploading_and_wearing_a_rigged_mesh) · [How to create animations](https://wiki.secondlife.com/wiki/How_to_create_animations)
