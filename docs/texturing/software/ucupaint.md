...
!!! info "About this page"
    **Prerequisites** — Comfortable Blender UV unwrapping, material nodes, and Edit Mode. Complete [Lesson 6 — UV unwrapping](../../modeling/uv-mapping.md) and [Organic PBR material](../projects/organic-pbr-material.md) first.  
...
Ucupaint is a Blender add-on, not a beginner Blender course. You must already know Blender UVs, materials, and Edit Mode. If your mesh has stretched UVs or no material slot, Ucupaint cannot fix that for you. Work through [Lesson 6 — UV unwrapping](../../modeling/uv-mapping.md) and build at least one complete material in [Organic PBR material](../projects/organic-pbr-material.md) before installing the add-on.
...
- **Hand-painted refinement** over procedural base coats from [Material Maker](material-maker.md) or [Adobe Substance 3D Painter](substance-painter.md).
...
- [Adobe Substance 3D Painter](substance-painter.md)
